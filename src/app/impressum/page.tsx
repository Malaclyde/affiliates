export default function Impressum() {
  return (
    <main>
      <h1>Impressum</h1>
      <p className="description">Angaben gemäß § 5 E-Commerce-Gesetz (ECG) und § 25 Medienservicesgesetz (MSG)</p>

      <h2>Betreiber</h2>
      <p>Malaclyde</p>
      <p>E-Mail: support@malaclyde.com</p>
      ...
      <p>
        ...
        österreichischen Urheberrechtsgesetz (UrhG). Die Vervielfältigung, Bearbeitung, Verbreitung und 
      ...
      <p>
        ...
        Die Erhebung personenbezogener Daten (z.B. Namen, Anschriften oder E-Mail-Adressen) erfolgt,
      ...
      <p>
        ...
        Übersendung von nicht ausdrücklich angefragten Werbung und Informationsmaterialien wird hiermit
        widersprochen. Die Betreiber der Seiten behalten sich ausdrücklich rechtliche Schritte im Falle
        der unverlangten Zusendung von Werbeinformationen vor, etwa durch Spam-E-Mails.
      </p>
