export default function Privacy() {
  return (
    <main>
      ...
      <p className="description">DSGVO (Datenschutz-Grundverordnung) compliant privacy policy</p>
      ...
      <p>
        ...
        Seitenaufrufs). Die Erfassung dieser Daten erfolgt automatisch, sobald Sie die Website betreten.
      </p>
      ...
      <p>
        ...
        widerrufen. Hierzu sowie zu weiteren Fragen zum Thema Datenschutz können Sie sich jederzeit
        an uns wenden.
      </p>

      <h2>2. Hosting</h2>
      <p>
        Die Inhalte unserer Website werden bei GitHub Pages gehostet. Anbieter ist die GitHub, Inc.,
        88 Colin P. Kelly Jr. Street, San Francisco, CA 94107, USA.
      </p>
      <p>
        GitHub Pages speichert alle Daten auf Servern von GitHub. Weitere Informationen finden Sie in
        der Datenschutzerklärung von GitHub: <a href="https://docs.github.com/en/site-policy/privacy-policies/github-general-privacy-statement" target="_blank" rel="noopener noreferrer">GitHub Privacy Statement</a>.
      </p>
      ...
      <p>
        ...
        formlose Mitteilung an uns per E-Mail. Die Rechtmäßigkeit der bis zum Widerruf erfolgten
      ...
      <p>
        ...
        Analyse der Nutzung der Website durch Sie ermöglichen. Die durch das Cookie erzeugten
        Informationen über Ihre Nutzung dieser Website werden in der Regel an einen Server von Google
      ...
      <p>
        Wenn Sie uns per E-Mail kontaktieren, wird Ihre E-Mail-Adresse sowie die Ihr E-Mail
        beigefügten Daten zwecks Bearbeitung Ihrer Anfrage bei uns gespeichert. Diese Daten
        werden nicht an Dritte weitergegeben. Die Verarbeitung dieser Daten erfolgt auf Grundlage
      ...
      <p>
        ...
        analysieren. Hierbei erhält der Websitebetreiber various Nutzungsdaten, wie Seitenaufrufe,
      ...
      <p>
        ...
        Verarbeitung Ihrer personenbezogenen Daten sowie das Recht auf Datenübertragbarkeit und das
